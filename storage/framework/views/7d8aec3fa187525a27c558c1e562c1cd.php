...
<body>
    <div class="li-shell">
        <div class="li-card">
            <div class="li-header">
                <img src="<?php echo e(asset(logo_path())); ?>" alt="<?php echo e(config('app.name')); ?>">
                <div class="li-app-name"><?php echo e(config('app.name')); ?></div>
            </div>
            ...
            <div class="li-footer-text">
                New to <?php echo e(config('app.name')); ?>?
                <a href="<?php echo e(route('signup')); ?>">Create a merchant account</a>
            </div>
...
<?php /**PATH C:\Users\dell\Downloads\Ipay-pg\resources\views/auth/login.blade.php ENDPATH**/ ?>
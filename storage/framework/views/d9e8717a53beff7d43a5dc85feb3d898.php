...
<?php $__env->startSection('title', 'Onboarding - ' . config('app.name')); ?>
<?php $__env->startSection('page-title', 'Complete Onboarding'); ?>
...
<div ng-app="ipayApp" ng-controller="OnboardingController as oc">
    ...
    <div class="stat-card mb-4">
        <div class="row g-3">
            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stepNum => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-3">
                <div class="card border <?php echo e($currentStep >= $stepNum ? 'border-primary' : ''); ?>">
                    <div class="card-body text-center">
                        <div class="mb-2">
                            <?php if($currentStep > $stepNum): ?>
                                <i class="bi bi-check-circle-fill text-success fs-3"></i>
                            <?php elseif($currentStep == $stepNum): ?>
                                <i class="bi <?php echo e($step['icon']); ?> text-primary fs-3"></i>
                            <?php else: ?>
                                <i class="bi <?php echo e($step['icon']); ?> text-muted fs-3"></i>
                            <?php endif; ?>
                        </div>
                        <h6 class="mb-1"><?php echo e($step['title']); ?></h6>
...
<?php echo $__env->make('merchant.onboarding.angular.main_controller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Downloads\Ipay-pg\resources\views/merchant/onboarding/index.blade.php ENDPATH**/ ?>
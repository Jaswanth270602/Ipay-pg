...
<?php $__env->startSection('title', 'PG Refund Approvals - Admin - ' . config('app.name')); ?>
<?php $__env->startSection('page-title', 'Approval Management'); ?>
        ...
        try {
            ...
            app.controller('PgRefundApprovalController', ['$http', '$scope', '$timeout', function ($http, $scope, $timeout) {
                ...
                vm.loadData = function () {
                    ...
                    $http.get("<?php echo e(route('admin.approvals.pg-refunds.data')); ?>", { params: params })
                ...
                vm.approve = function (item) {
                    ipayConfirm('Are you sure you want to approve this request?', 'warning', {
                        ...
                        if (!ok) return;
                        $timeout(function () {
                            $http.post("<?php echo e(url('admin/approvals/pg-refunds')); ?>/" + item.id + "/approve", {}, {
                ...
                vm.reject = function (item) {
                    ipayConfirm('Are you sure you want to reject this request?', 'danger', {
                        ...
                        if (!ok) return;
                        $timeout(function () {
                            $http.post("<?php echo e(url('admin/approvals/pg-refunds')); ?>/" + item.id + "/reject", {}, {
                                headers: { 'X-CSRF-TOKEN': csrf }
                            }).then(function (response) {
                                if (response.data && response.data.success) {
                                    if (typeof showToast === 'function') {
                ...
                vm.bulkApprove = function () {
                    ...
                    ipayConfirm('Are you sure you want to approve selected items?', 'warning', {
                        ...
                        if (!ok) return;
                        $timeout(function () {
                            $http.post("<?php echo e(route('admin.approvals.pg-refunds.bulk-action')); ?>", {
...
<?php echo $__env->make('layouts.app-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Downloads\Ipay-pg\resources\views/admin/approvals/pg-refunds.blade.php ENDPATH**/ ?>
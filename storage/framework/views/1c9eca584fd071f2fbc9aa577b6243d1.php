...
<div ng-app="ipayApp" ng-controller="DashboardController as dc">
    <div class="row mb-4">
        <div class="col-md-12">
            <h3 class="fw-bold" style="color:#E10600;">Welcome, <?php echo e($user->name); ?></h3>
            ...
            <div class="stat-card card-volume flip-volume-wrap">
                <div class="flip-volume-inner" id="merchantVolumeFlipInner">
                    ...
                    <div class="flip-volume-face flip-volume-back">
                        ...
                        <div class="flip-volume-metric">
                            <h3 class="fw-bold mb-1"><?php echo e($merchant->default_currency); ?> <?php echo e(number_format($stats['net_volume'], 2)); ?></h3>
    ...
    <div class="row g-4">
        <div class="col-md-8">
            <div class="stat-card">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <a href="<?php echo e(route('merchant.payment_links.index')); ?>" class="card quick-action-card card-payment-link">
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo e(route('merchant.transactions.index')); ?>" class="card quick-action-card card-transactions">
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo e(route('merchant.integration.index')); ?>" class="card quick-action-card card-integration">
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo e(route('merchant.api_keys.index')); ?>" class="card quick-action-card card-api-keys">
                            <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="mb-3">
                    ...
                    <a href="<?php echo e(route('merchant.integration.index')); ?>#api-docs-tab" class="btn btn-sm btn-outline-primary">View API Docs</a>
                </div>
        ...
        <div class="col-md-12">
            <div class="stat-card" style="border-radius: 16px; border: 1px solid #e5e7eb;">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?php echo e(route('merchant.transactions.index')); ?>" class="btn btn-sm btn-outline-primary">
                        View All
                    </a>
                </div>
                        ...
                        <table class="table align-middle mb-0 recent-transactions-table">
                            ...
                            <tbody>
                                <tr ng-repeat="txn in dc.recentTransactions" class="align-middle">
                                    <td>
                                        <a href="<?php echo e(route('merchant.transactions.index')); ?>"
...
<?php echo $__env->make('layouts.app-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Downloads\Ipay-pg\resources\views/merchant/dashboard.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', config('app.name') . ' – Modern Payment Gateway'); ?>
...
<div class="lp-shell">
        ...
        <div class="lp-hero-row">
            <div>
                ...
                <p class="lp-hero-subtitle mb-3">
                    Seamlessly accept debit and credit card payments with <?php echo e(config('app.name')); ?>, while leveraging 1000+ alternative payment methods for global customers.
                </p>
                <div class="lp-hero-actions">
                    <a href="<?php echo e(route('signup')); ?>" class="lp-btn-primary">
                        Start free sandbox
                        <i class="bi bi-arrow-right-short"></i>
                    </a>
                    <a href="<?php echo e(route('products.page')); ?>" class="lp-btn-ghost">
                        Explore products
                    </a>
                </div>
    ...
    <section class="lp-section">
        <div class="lp-section-header">
            <div class="lp-section-title">Why teams choose <?php echo e(config('app.name')); ?></div>
    ...
    <section class="lp-section">
        ...
        <div class="lp-split-row">
            <div>
                ...
                <a href="<?php echo e(route('products.page')); ?>" class="lp-btn-primary mt-1">
            ...
            <div class="text-end">
                <div style="display:inline-block;border-radius:24px;overflow:hidden;box-shadow:0 24px 60px rgba(15,23,42,0.25);width:100%;max-width:360px;height:220px;background:#f3f4f6;">
                    <img src="<?php echo e(asset('images/landing-payments.png')); ?>" alt="Payments and customers worldwide" class="w-100 h-100" style="object-fit:cover;">
                </div>
            </div>
        </div>
        </div>
    ...
    <section class="lp-section" style="padding-top:16px;">
        <div class="lp-section-header">
            ...
            <p class="lp-section-subtitle">Join the businesses that rely on <?php echo e(config('app.name')); ?> to move money confidently across borders.</p>
        </div>
            ...
            <div class="lp-split-row">
                <div>
                    <div class="lp-logo-grid">
                        <?php $__currentLoopData = ['VISA','Mastercard','UPI','Netbanking','Alipay','PIX','M-Pesa','SEPA','KakaoPay','iDEAL','OXXO','POLi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="lp-logo-cell"><?php echo e($logo); ?></div>
                ...
                <div>
                    ...
                    <p class="lp-section-subtitle" style="text-align:left;margin-left:0;margin-bottom:14px;">
                        <?php echo e(config('app.name')); ?> partners with leading local payment methods so you can accept
                        cards, wallets, bank transfers and more in key regions around the world.
                    </p>
                    <a href="<?php echo e(route('products.page')); ?>" class="lp-btn-ghost mt-1">
    ...
    <section class="lp-section" style="padding-top:16px;padding-bottom:72px;">
        <div class="lp-cta-strip">
            <h3 style="font-size:22px;font-weight:700;color:var(--pg-text-main);margin-bottom:6px;">
                Get your free <?php echo e(config('app.name')); ?> account now
            </h3>
...
<?php echo $__env->make('layouts.marketing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Downloads\Ipay-pg\resources\views/landing.blade.php ENDPATH**/ ?>
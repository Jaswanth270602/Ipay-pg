...
<?php $__env->startSection('title', 'Refunds - ' . config('app.name')); ?>
<?php $__env->startSection('page-title','Refunds'); ?>
...
<div ng-app="ipayApp" ng-controller="RefundsController as rc">
    <div class="alert alert-info d-flex align-items-start gap-2 mb-3" role="alert">
        ...
        <div class="small">
            ...
            — Refunds below <strong><?php echo e(number_format($refundApprovalThreshold, 0)); ?></strong> (in the <strong>same currency</strong> as the original payment) can be submitted directly when your account rules allow.
            Refunds of <strong><?php echo e(number_format($refundApprovalThreshold, 0)); ?> or more</strong> are sent for <strong>admin approval</strong> first; they appear as <span class="badge bg-warning text-dark">PENDING_APPROVAL</span> until approved or rejected.
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="small text-muted mb-3">
                        Amounts <strong>≥ <?php echo e(number_format($refundApprovalThreshold, 0)); ?></strong> (same currency as the transaction) require <strong>admin approval</strong> before processing.
                    </p>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="refundCurrency" ng-model="rc.newRefund.currency" required>
                                        <?php echo $__env->make('components.currency-options', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </select>
...
<?php echo $__env->make('merchant.refunds.angular.main_controller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Downloads\Ipay-pg\resources\views/merchant/refunds/index.blade.php ENDPATH**/ ?>
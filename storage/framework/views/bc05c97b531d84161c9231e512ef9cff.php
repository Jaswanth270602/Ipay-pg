...
<head>
    ...
    <style>
        :root {
            ...
            --brand-dark: #111827;
            --primary-violet: #7c3aed;          /* purple */
            --primary-violet-dark: #ec4899;     /* pink */
            --primary-violet-light: #a78bfa;
            --gradient-start: #7c3aed;
            --gradient-end: #ec4899;
            --sidebar-bg: #1A1D24;
            --sidebar-hover: rgba(225, 6, 0, 0.16);
        ...
        * {
        ...
        .sidebar-menu-item.active {
            background: linear-gradient(90deg, rgba(225, 6, 0, 0.25) 0%, rgba(225, 6, 0, 0.12) 100%);
            color: #fff;
        ...
        /* Buttons */
        .btn-primary {
            background: linear-gradient(135deg, var(--brand-red) 0%, #f97373 100%);
            border: none;
            padding: 10px 24px;
            border-radius: 8px;
            font-weight: 600;
        ...
        .btn-primary:hover {
            background: linear-gradient(135deg, #b00500 0%, var(--brand-red) 100%);
...
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        ...
        <div class="sidebar-brand">
            <img src="<?php echo e(asset(logo_path())); ?>" alt="<?php echo e(config('app.name')); ?>" style="height:42px; width:auto;">
            <span class="brand-name"><?php echo e(config('app.name')); ?></span>
        </div>
            ...
            <?php elseif(auth()->user()->isAdmin()): ?>
                <div class="mode-badge <?php echo e(session('admin_view_mode', 'test') === 'test' ? 'bg-warning text-dark' : 'bg-success'); ?>" id="adminModeBadge">
                    <?php echo e(session('admin_view_mode', 'test') === 'test' ? 'TEST MODE' : 'LIVE MODE'); ?>
    ...
    <nav class="sidebar-menu">
        ...
        <?php if(auth()->user()->isMerchant()): ?>
        <!-- Payments Dropdown -->
        <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('merchant.payments.*') || request()->routeIs('merchant.transactions.*') || request()->routeIs('merchant.refunds.*') ? 'active' : ''); ?>" onclick="toggleDropdown(this)">
            <i class="bi bi-wallet2"></i>
            <span>Payments</span>
            <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
        </div>
        <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('merchant.payments.*') || request()->routeIs('merchant.transactions.*') || request()->routeIs('merchant.refunds.*') ? 'block' : 'none'); ?>;">
            <a href="<?php echo e(route('merchant.transactions.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('merchant.transactions.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-credit-card"></i>
                <span>Transactions</span>
            </a>
            <a href="<?php echo e(route('merchant.refunds.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('merchant.refunds.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-arrow-counterclockwise"></i>
                <span>Refunds</span>
            </a>
            <a href="<?php echo e(route('merchant.payments.bulk-refund-update')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('merchant.payments.bulk-refund-update*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-upload"></i>
                <span>Bulk Update Refund Status</span>
            </a>
            <a href="<?php echo e(route('merchant.payments.chargebacks')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('merchant.payments.chargebacks*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-exclamation-triangle"></i>
                <span>Chargebacks Upload</span>
            </a>
            <a href="<?php echo e(route('merchant.payments.bulk-chargebacks')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('merchant.payments.bulk-chargebacks*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-cloud-upload"></i>
                <span>Bulk Chargebacks Upload</span>
            </a>
            <a href="<?php echo e(route('merchant.payments.split-transactions')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('merchant.payments.split-transactions*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-diagram-3"></i>
                <span>Split Transactions</span>
            </a>
            <a href="<?php echo e(route('merchant.payments.federal-vpa')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('merchant.payments.federal-vpa*') ? 'active' : ''); ?>" style="padding-left: 50px;">
        ...
        <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('merchant.settlements.*') ? 'active' : ''); ?>" onclick="toggleDropdown(this)">
            <i class="bi bi-file-earmark-text"></i>
            <span>Settlements</span>
            <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
        </div>
        <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('merchant.settlements.*') ? 'block' : 'none'); ?>;">
            <a href="<?php echo e(route('merchant.settlements.summary')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('merchant.settlements.summary*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-list-ul"></i>
                <span>Settlement Summary</span>
            </a>
            <a href="<?php echo e(route('merchant.settlements.details')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('merchant.settlements.details*') ? 'active' : ''); ?>" style="padding-left: 50px;">
        ...
        <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.merchants.*') || request()->routeIs('admin.merchant-accounts.*') || request()->routeIs('admin.merchant-registration-keys.*') || request()->routeIs('admin.merchant-vendors.*') || request()->routeIs('admin.base-rates.*') ? 'active' : ''); ?>" onclick="toggleDropdown(this)">
            <i class="bi bi-building"></i>
            <span>Merchants</span>
            <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
        </div>
        <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.merchants.*') || request()->routeIs('admin.merchant-accounts.*') || request()->routeIs('admin.merchant-registration-keys.*') || request()->routeIs('admin.merchant-vendors.*') || request()->routeIs('admin.base-rates.*') ? 'block' : 'none'); ?>;">
            <a href="<?php echo e(route('admin.merchants.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.merchants.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-list-ul"></i>
            ...
            <a href="<?php echo e(route('admin.merchant-registration-keys.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.merchant-registration-keys.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-key"></i>
                <span>Merchant Registration Keys</span>
            </a>
            <a href="<?php echo e(route('admin.merchant-vendors.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.merchant-vendors.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-people"></i>
                <span>Merchant Vendors</span>
            </a>
            <a href="<?php echo e(route('admin.base-rates.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.base-rates.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-percent"></i>
                <span>Base Rates</span>
            </a>
        </div>
        <!-- Partners Management Dropdown -->
        <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.partners.*') ? 'active' : ''); ?>" onclick="toggleDropdown(this)">
            <i class="bi bi-people"></i>
            <span>Partners Management</span>
            <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
        </div>
        <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.partners.*') ? 'block' : 'none'); ?>;">
            <a href="<?php echo e(route('admin.partners.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.partners.index') || request()->routeIs('admin.partners.data') || request()->routeIs('admin.partners.store') || request()->routeIs('admin.partners.update') || request()->routeIs('admin.partners.destroy') || request()->routeIs('admin.partners.show') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-list-ul"></i>
                <span>Partner Details</span>
            </a>
            <a href="<?php echo e(route('admin.partners.tdr')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.partners.tdr*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-file-earmark-text"></i>
                <span>Partner TDR Details</span>
            </a>
        </div>
        <!-- Partner Settlements Dropdown - Separate Module -->
        <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.partner-settlements.*') ? 'active' : ''); ?>" onclick="toggleDropdown(this)">
            <i class="bi bi-handshake"></i>
            <span>Partner Settlements</span>
            <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
        </div>
        <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.partner-settlements.*') ? 'block' : 'none'); ?>;">
            <a href="<?php echo e(route('admin.partner-settlements.summary')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.partner-settlements.summary') || request()->routeIs('admin.partner-settlements.data') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-list-ul"></i>
                <span>Partner Settlement Summary</span>
            </a>
            <a href="<?php echo e(route('admin.partner-settlements.details')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.partner-settlements.details') || request()->routeIs('admin.partner-settlements.details.data') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-file-earmark-text"></i>
        ...
        <a href="<?php echo e(route('admin.orders.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>">
            <i class="bi bi-cart-check"></i>
            <span>All Orders</span>
        </a>
        <!-- Reports Dropdown -->
        <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.reports.*') ? 'active' : ''); ?>" onclick="toggleDropdown(this)">
            <i class="bi bi-file-earmark-bar-graph"></i>
            <span>Reports</span>
            <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
        </div>
        <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.reports.*') ? 'block' : 'none'); ?>;">
            <a href="<?php echo e(route('admin.reports.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.index') && !request()->routeIs('admin.reports.gst-invoices.*') && !request()->routeIs('admin.reports.success-rate.*') && !request()->routeIs('admin.reports.profitability.*') && !request()->routeIs('admin.reports.sales.*') && !request()->routeIs('admin.reports.datatable-exports.*') && !request()->routeIs('admin.reports.miscellaneous.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-bar-chart"></i>
                <span>Reports</span>
            </a>
            <!-- GST Invoices Submenu -->
            <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.reports.gst-invoices.*') ? 'active' : ''); ?>" onclick="event.stopPropagation(); toggleDropdown(this);" style="padding-left: 50px;">
                <i class="bi bi-receipt"></i>
                <span>Gst Invoices</span>
                <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
            </div>
            <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.reports.gst-invoices.*') ? 'block' : 'none'); ?>; padding-left: 50px;">
                <a href="<?php echo e(route('admin.reports.gst-invoices.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.gst-invoices.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                    <i class="bi bi-file-earmark-text"></i>
                    <span>Gst Invoices Report</span>
                </a>
            </div>
            <!-- Success Rate Submenu -->
            <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.reports.success-rate.*') ? 'active' : ''); ?>" onclick="event.stopPropagation(); toggleDropdown(this);" style="padding-left: 50px;">
                <i class="bi bi-graph-up"></i>
                <span>Success Rate</span>
                <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
            </div>
            <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.reports.success-rate.*') ? 'block' : 'none'); ?>; padding-left: 50px;">
                <a href="<?php echo e(route('admin.reports.success-rate.bankcode-wise')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.success-rate.bankcode-wise*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                    <i class="bi bi-bank"></i>
                    <span>Bankcode-wise</span>
                </a>
            </div>
            <!-- Profitability Submenu -->
            <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.reports.profitability.*') ? 'active' : ''); ?>" onclick="event.stopPropagation(); toggleDropdown(this);" style="padding-left: 50px;">
                <i class="bi bi-bar-chart"></i>
                <span>Profitability</span>
                <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
            </div>
            <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.reports.profitability.*') ? 'block' : 'none'); ?>; padding-left: 50px;">
                <a href="<?php echo e(route('admin.reports.profitability.partner-team-profit')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.profitability.partner-team-profit*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                    <i class="bi bi-people"></i>
                    <span>Partner Team Profit</span>
                </a>
            </div>
            <!-- Sales Submenu -->
            <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.reports.sales.*') ? 'active' : ''); ?>" onclick="event.stopPropagation(); toggleDropdown(this);" style="padding-left: 50px;">
                <i class="bi bi-bar-chart-line"></i>
                <span>Sales</span>
                <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
            </div>
            <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.reports.sales.*') ? 'block' : 'none'); ?>; padding-left: 50px;">
                <a href="<?php echo e(route('admin.reports.sales.date-and-merchant')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.sales.date-and-merchant*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                    <i class="bi bi-square"></i>
                    <span>Date And Merchant</span>
                </a>
                <a href="<?php echo e(route('admin.reports.sales.date-and-acquirer')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.sales.date-and-acquirer*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                    <i class="bi bi-square"></i>
                    <span>Date And Acquirer</span>
                </a>
                <a href="<?php echo e(route('admin.reports.sales.date-and-tid')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.sales.date-and-tid*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                    <i class="bi bi-square"></i>
                    <span>Date And Tid</span>
                </a>
                <a href="<?php echo e(route('admin.reports.sales.month-and-merchant')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.sales.month-and-merchant*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                    <i class="bi bi-square"></i>
                    <span>Month And Merchant</span>
                </a>
                <a href="<?php echo e(route('admin.reports.sales.month-and-acquirer')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.sales.month-and-acquirer*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                    <i class="bi bi-square"></i>
                    <span>Month And Acquirer</span>
                </a>
                <a href="<?php echo e(route('admin.reports.sales.month-and-tid')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.sales.month-and-tid*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                    <i class="bi bi-square"></i>
                    <span>Month And Tid</span>
                </a>
            </div>
            <!-- Datatable Exports Submenu -->
            <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.reports.datatable-exports.*') ? 'active' : ''); ?>" onclick="event.stopPropagation(); toggleDropdown(this);" style="padding-left: 50px;">
                <i class="bi bi-cloud-download"></i>
                <span>Datatable Exports</span>
                <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
            </div>
            <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.reports.datatable-exports.*') ? 'block' : 'none'); ?>; padding-left: 50px;">
                <a href="<?php echo e(route('admin.reports.datatable-exports.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.datatable-exports.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                    <i class="bi bi-file-earmark-text"></i>
                    <span>Datatable Export List</span>
                </a>
            </div>
            <!-- Miscellaneous Submenu -->
            <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.reports.miscellaneous.*') ? 'active' : ''); ?>" onclick="event.stopPropagation(); toggleDropdown(this);" style="padding-left: 50px;">
                <i class="bi bi-clock"></i>
                <span>Miscellaneous</span>
                <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
            </div>
            <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.reports.miscellaneous.*') ? 'block' : 'none'); ?>; padding-left: 50px;">
                <a href="<?php echo e(route('admin.reports.miscellaneous.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.reports.miscellaneous.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                    <i class="bi bi-file-earmark-text"></i>
        ...
        <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.s2s-callback-logs.*') ? 'active' : ''); ?>" onclick="toggleDropdown(this)">
            <i class="bi bi-tools"></i>
            <span>Technical Diagnostics</span>
            <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
        </div>
        <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.s2s-callback-logs.*') ? 'block' : 'none'); ?>;">
            <a href="<?php echo e(route('admin.s2s-callback-logs.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.s2s-callback-logs.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
        ...
        <!-- Approvals Dropdown -->
        <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.approvals.*') ? 'active' : ''); ?>" onclick="toggleDropdown(this)">
            <i class="bi bi-check-circle"></i>
            <span>Approvals</span>
            <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
        </div>
        <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.approvals.*') ? 'block' : 'none'); ?>;">
            <a href="<?php echo e(route('admin.approvals.merchant-tdr')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.approvals.merchant-tdr*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-list"></i>
                <span>Merchant TDR</span>
            </a>
            <a href="<?php echo e(route('admin.approvals.pg-refunds')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.approvals.pg-refunds*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-list"></i>
        ...
        <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.acquirer.*') ? 'active' : ''); ?>" onclick="toggleDropdown(this)">
            <i class="bi bi-credit-card-2-front"></i>
            <span>Acquirer Details</span>
            <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
        </div>
        <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.acquirer.*') ? 'block' : 'none'); ?>;">
            <a href="<?php echo e(route('admin.acquirer.accounts.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.acquirer.accounts.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-bank"></i>
                <span>Acquirer Accounts</span>
            </a>
            <a href="<?php echo e(route('admin.acquirer.detail-upload.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.acquirer.detail-upload.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-upload"></i>
                <span>Acquirer Accounts Detail Upload</span>
            </a>
            <a href="<?php echo e(route('admin.acquirer.rates.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.acquirer.rates.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
                <i class="bi bi-percent"></i>
        ...
        <div class="sidebar-menu-item sidebar-menu-dropdown <?php echo e(request()->routeIs('admin.users.*') || request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*') ? 'active' : ''); ?>" onclick="toggleDropdown(this)">
            <i class="bi bi-people"></i>
            <span>User Settings</span>
            <i class="bi bi-chevron-down ms-auto" style="font-size: 12px;"></i>
        </div>
        <div class="sidebar-submenu" style="display: <?php echo e(request()->routeIs('admin.users.*') || request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*') ? 'block' : 'none'); ?>;">
            <a href="<?php echo e(route('admin.users.index')); ?>" class="sidebar-menu-item sidebar-submenu-item <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>" style="padding-left: 50px;">
...
<div class="main-content">
    <div class="topbar">
        ...
        <div class="topbar-actions">
            ...
            <?php elseif(auth()->user()->isAdmin()): ?>
            <div class="mode-toggle">
                <button class="mode-toggle-btn <?php echo e(session('admin_view_mode', 'test') === 'test' ? 'active test' : ''); ?>" onclick="switchAdminMode('test')">
                    <i class="bi bi-flask"></i> Test
                </button>
                <button class="mode-toggle-btn <?php echo e(session('admin_view_mode', 'test') === 'live' ? 'active live' : ''); ?>" onclick="switchAdminMode('live')">
                    <i class="bi bi-check-circle"></i> Live
                </button>
            </div>
            <?php endif; ?>
                ...
                <ul class="dropdown-menu dropdown-menu-end profile-dropdown-menu" aria-labelledby="profileDropdown">
                    <li class="profile-dropdown-header">
                        ...
                        <div class="merchant-id-badge">
                            <i class="bi bi-building"></i> Merchant ID: <strong><?php echo e(auth()->user()->merchant->id); ?></strong>
                        </div>
                    </li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <a class="dropdown-item profile-menu-item" href="<?php echo e(route('merchant.profile.index')); ?>">
                            <i class="bi bi-person"></i> Profile
                        </a>
                    </li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <form action="<?php echo e(route('logout')); ?>" method="POST" class="d-inline w-100 logout-form">
                            <?php echo csrf_field(); ?>
...
function switchAdminMode(mode) {
    ...
    fetch("<?php echo e(route('admin.settings.switch-mode')); ?>", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').content
...
<?php echo $__env->make('components.ipay-modals', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
(function () {
    ...
    function refreshNotifications() {
        return Promise.all([
            getJSON('<?php echo e(route('notifications.unread-count')); ?>'),
            getJSON('<?php echo e(route('notifications.index')); ?>')
        ]).then(function (res) {
            var countRes = res[0] || {};
            var listRes = res[1] || {};
    ...
    listEl.addEventListener('click', function (e) {
        ...
        if (id) {
            postJSON('<?php echo e(route('notifications.mark-as-read')); ?>', { ids: [Number(id)] })
    ...
    dropdownBtn.addEventListener('show.bs.dropdown', function () {
        refreshNotifications().then(function () {
            ...
            if (unreadIds.length) {
                postJSON('<?php echo e(route('notifications.mark-as-read')); ?>', { ids: unreadIds })
                    .then(function () { refreshNotifications(); })
                    .catch(function () {});
            }
        });
...
<?php echo $__env->yieldPushContent('scripts'); ?>
    ...
    <script>
        (function () {
            try {
                ...
                function doLogout() {
                    try {
                        var logoutForms = document.querySelectorAll('form[action="<?php echo e(route('logout')); ?>"]');
 ...
 <?php /**PATH C:\Users\dell\Downloads\Ipay-pg\resources\views/layouts/app-sidebar.blade.php ENDPATH**/ ?>
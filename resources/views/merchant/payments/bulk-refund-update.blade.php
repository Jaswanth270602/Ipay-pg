    ...
    <div class="stat-card mb-4">
        ...
        <form id="bulkRefundUploadForm" enctype="multipart/form-data">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-4">
                    <input type="file" class="form-control" id="refundFile" accept=".csv,.xlsx,.xls" ng-model="mbruc.selectedFile" onchange="document.getElementById('fileNameDisplay').value = this.files[0]?.name || 'No Files Selected'">
                </div>
                <div class="col-md-3">
            ...
            <div class="row mt-2">
                <div class="col-md-12">
                    ...
                    <small class="text-muted d-block mt-1">
                        ...
                        Use the template for the exact header row; currency values are applied when updating a refund row.
                    </small>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-md-12 text-center">
                    <button type="button" class="btn btn-success btn-lg" ng-click="mbruc.uploadFile()" ng-disabled="!mbruc.selectedFile || mbruc.uploading">

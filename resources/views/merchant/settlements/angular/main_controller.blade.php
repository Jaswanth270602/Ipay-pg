...
(function() {
    ...
    function registerController() {
        ...
        try {
            ...
            app.controller('SettlementsController', ['$http', '$timeout', function($http, $timeout) {
        var vm = this;
        vm.settlements = [];
        vm.loading = false;
        vm.perPage = 10;
        ...
        vm.loadSettlements = function() {
            ...
            $http.get('/merchant/settlements/data', { params: params }).then(function(response) {
                ...
                if (typeof showToast === 'function') {
                    showToast('Unable to load settlements. Please try again.', 'error');
                } else {
                    alert('Unable to load settlements. Please try again.');
                }
        ...
        vm.exportCSV = function() {
            ...
            window.location.href = '/merchant/settlements/export?' + queryString;
        };

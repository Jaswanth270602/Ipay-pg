                ...
                <table class="table table-hover bulk-refund-jobs-table">
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="job in abruc.jobs track by $index">
                            <td ng-show="abruc.visibleColumns.job_id.visible">
                                <div class="compact-cell">@{{ job.job_id }}</div>
                            </td>
                            <td ng-show="abruc.visibleColumns.job_name.visible">
                                <div class="job-name-cell">@{{ job.job_name }}</div>
                            </td>
                            <td ng-show="abruc.visibleColumns.progress.visible">
                            ...
                            <td ng-show="abruc.visibleColumns.started_at.visible">
                                <div class="compact-cell">@{{ job.started_at }}</div>
                            </td>
                            <td ng-show="abruc.visibleColumns.finished_at.visible">
                                <div class="compact-cell">@{{ job.finished_at }}</div>
                            </td>
                            <td ng-show="abruc.visibleColumns.error.visible">
                                <div class="job-detail-cell">@{{ job.error }}</div>
                            </td>
                            <td ng-show="abruc.visibleColumns.status_info.visible">

...
@section('title', 'Sales Month and TID Report - Admin - ' . config('app.name'))
@section('page-title', 'Sales Month and TID Report')

@section('content')
@include('reports.partials.sales-report-styles')
<div ng-cloak class="sales-report-page" ng-app="ipayApp" ng-controller="SalesMonthAndTidController as sr">
    <x-breadcrumbs :items="[
    ...
    <div class="row mb-4">
        <div class="col-md-12 d-flex justify-content-between align-items-center">
            <div>
                ...
                <h3 class="mb-0" style="color: #adb5bd; font-size: 1rem; font-weight: normal;">Month and TID</h3>
            </div>
            <div>
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <h3 class="mb-0" style="color: #495057; font-size: 1.25rem; font-weight: 600;">SALES Month and TID Report</h3>
        </div>
    </div>
        ...
        try {
            ...
            app.controller('SalesMonthAndTidController', ['$http', '$scope', function ($http, $scope) {
                ...
                vm.loadData = function () {
                    ...
                    $http.get("{{ route('admin.reports.sales.month-and-tid.data') }}", { params: params })

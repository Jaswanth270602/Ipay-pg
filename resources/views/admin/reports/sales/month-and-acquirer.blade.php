...
@section('title', 'Sales Month and Acquirer Report - Admin - ' . config('app.name'))
@section('page-title', 'Sales Month and Acquirer Report')

@section('content')
<div ng-app="badlicashApp" ng-controller="SalesMonthAndAcquirerController as sr">
    <x-breadcrumbs :items="[
    ...
    <div class="row mb-4">
        <div class="col-md-12 d-flex justify-content-between align-items-center">
            <div>
                ...
                <h3 class="mb-0" style="color: #adb5bd; font-size: 1rem; font-weight: normal;">Month and Acquirer</h3>
            </div>
            <div>
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <h3 class="mb-0" style="color: #495057; font-size: 1.25rem; font-weight: 600;">SALES Month and Acquirer Report</h3>
        </div>
    </div>
...
(function () {
    ...
    function registerController() {
        ...
        try {
            ...
            app.controller('SalesMonthAndAcquirerController', ['$http', '$scope', function ($http, $scope) {
                var vm = this;
                ...
                vm.loadData = function () {
                    ...
                    $http.get("{{ route('admin.reports.sales.month-and-acquirer.data') }}", { params: params })

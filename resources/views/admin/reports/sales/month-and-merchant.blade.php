...
@section('title', 'Sales Month and Merchant Report - Admin - ' . config('app.name'))
@section('page-title', 'Sales Month and Merchant Report')

@section('content')
<div ng-app="badlicashApp" ng-controller="SalesMonthAndMerchantController as sr">
    <x-breadcrumbs :items="[
    ...
    <div class="row mb-4">
        <div class="col-md-12 d-flex justify-content-between align-items-center">
            <div>
                ...
                <h3 class="mb-0" style="color: #adb5bd; font-size: 1rem; font-weight: normal;">Month and Merchant</h3>
            </div>
            <div>
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <h3 class="mb-0" style="color: #495057; font-size: 1.25rem; font-weight: 600;">SALES Month and Merchant Report</h3>
        </div>
    </div>
            ...
            <div class="d-flex gap-2 flex-wrap">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><label class="dropdown-item"><input type="checkbox" ng-model="sr.visibleColumns.merchant_name" checked> Merchant Name</label></li>
                        <li><label class="dropdown-item"><input type="checkbox" ng-model="sr.visibleColumns.transaction_month" checked> Transaction Month</label></li>
                ...
                <table class="table table-hover align-middle">
                    <thead>
                        <tr>
                            ...
                            <th ng-show="sr.visibleColumns.transaction_month">
                                <i class="bi bi-diamond"></i> Transaction Month
                            </th>
                        ...
                        <tr>
                            ...
                            <th ng-show="sr.visibleColumns.transaction_month">
                                <input type="text" class="form-control form-control-sm" ng-model="sr.tableFilters.transaction_month" ng-change="sr.applyTableFilters()" placeholder="Transaction Month">
                            </th>
                            <th ng-show="sr.visibleColumns.transaction_count">
                    ...
                    <tbody>
                        <tr ng-if="sr.data.length === 0 && !sr.loading">
                            <td colspan="4" class="text-center text-danger py-4">No matching records found</td>
                        </tr>
                        <tr ng-repeat="item in sr.data track by $index">
                            <td ng-show="sr.visibleColumns.merchant_name">@{{ item.merchant_name || 'N/A' }}</td>
                            <td ng-show="sr.visibleColumns.transaction_month">@{{ item.transaction_month || 'N/A' }}</td>
...
(function () {
    ...
    function registerController() {
        ...
        try {
            ...
            app.controller('SalesMonthAndMerchantController', ['$http', '$scope', function ($http, $scope) {
                var vm = this;
                ...
                vm.loadData = function () {
                    ...
                    $http.get("{{ route('admin.reports.sales.month-and-merchant.data') }}", { params: params })

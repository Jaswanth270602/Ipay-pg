...
return new class extends Migration
{
    ...
    {
        Schema::create('pg_refund_approvals', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('model_id')->nullable()->comment('Model ID (Refund ID)');
    ...
    {
        Schema::dropIfExists('pg_refund_approvals');
    }
};
